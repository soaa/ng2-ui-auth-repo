...
class SharedService {
    ...
    getToken() {
        return __awaiter(this, void 0, void 0, function* () {
            let /** @type {?} */ token = yield this.storage.get(this.tokenName);
            return token;
        });
    }
    /**
    ...
    getExpirationDate(token) {
        return __awaiter(this, void 0, void 0, function* () {
            token = token || (yield this.getToken());
            const /** @type {?} */ payload = yield this.getPayload(token);
...
class PopupService {
    ...
    eventListener(popupWindow, redirectUri) {
        ...
        return merge$1(fromEvent$1(popupWindow, 'exit').pipe(delay(100), map(() => { throw new Error('Authentication Canceled'); })), fromEvent$1(popupWindow, 'loadstart')).pipe(switchMap((event) => {
            ...
            if (parser.search || parser.hash) {
                ...
                const /** @type {?} */ allParams = Object.assign({}, qs, hash);
                popupWindow.close();
                if (allParams.error) {
        ...
        return [
            ...
            ...additionalUrlParams
                ? Object
                    ...
                    .map((key) => {
                    const /** @type {?} */ value = ((additionalUrlParams))[key];
...
class OauthService {
     ...
     * @param {?} popup
     */
    constructor(http$$1, shared, config, popup) {
        this.http = http$$1;
        this.shared = shared;
        this.config = config;
        this.popup = popup;
    ...
    authenticate(name, userData) {
        const /** @type {?} */ provider = this.providerOf(name);
        return provider.open(this.config.options.providers[name], userData || {})
            ...
            if (this.config.options.providers[name].url) {
                return Observable$2.from(this.shared.setToken(response)).map(() => response);
            }

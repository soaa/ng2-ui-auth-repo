...
var PopupService = (function () {
    ...
    PopupService.prototype.eventListener = function (popupWindow, redirectUri) {
        ...
        return merge$1(fromEvent$1(popupWindow, 'exit').pipe(delay(100), map(function () { throw new Error('Authentication Canceled'); })), fromEvent$1(popupWindow, 'loadstart')).pipe(switchMap(function (event) {
    ...
    PopupService.prototype.pollPopup = function (popupWindow, redirectUri) {
        var _this = this;
        return interval$1(50)
            .pipe(switchMap(function () {
            if (!popupWindow || popupWindow.closed) {
                return _throw$1(new Error('Authentication Canceled'));
            }
...
var OauthService = (function () {
    ...
    OauthService.prototype.providerOf = function (name) {
        return this.config.options.providers[name].oauthType === '1.0'
            ? Injector.create(this.depProviders.concat([
